 ...
 *  It's a 2D array, holding all the game playing informations about boardData.
 ...
 *  The second demension contains 17 elements, which is 16 tiles (row x column) + boardSwipeGesture information.
