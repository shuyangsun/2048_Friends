...
extern const CGFloat kTileWidthFractionDefault_iPhone; // Comparing with board width
extern const CGFloat kTileWidthFractionDefault_iPad;
...
@property (nonatomic) CGFloat tileWidthFraction; // Comparing with screen width
